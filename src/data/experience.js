...
- **python 實作優化：**我學會如何讓 python 有效運用資源，尤其在多迴圈時，用多線程、迴圈優化等方式來提升速度`,
        links: [
          { label: "🔗 查看專案", url: "https://github.com/leolinpotato/ntu-vfx-2024" },
          { label: "🎥 Blender 特效製作", url: "https://www.youtube.com/watch?v=e7_iIwEm398" },
          { label: "🎥 期末專案", url: "https://youtu.be/KqNNqOy3fpY?si=4KVSvJS_8_uxlPGE" },
        ],
      },
      {
        date: "2024 Fall",
...
- **git 使用**：學會如何使用 git 以及 github 在團體中進行版本控制`,
        links: [
          { label: "🎮 玩遊戲", url: "https://fhvirus.itch.io/caged?fbclid=IwZXh0bgNhZW0CMTAAAR3sYiRt9_hX8UyU68FCerY5O92KcjUp45jFvAippdTQ-LYH3yQsvf7chzQ_aem__vxlOau9PK69ds_E1oiPTQ" },
        ],
      },
      {
        date: "2024",
...
- **獨立創作**：培養獨立學習新知及解決問題的能力`,
        links: [
          { label: "🔗 查看專案", url: "https://github.com/stanfc/Youtube-Comment-Emotion-Prediction-Tool" },
        ],
      },
      {
        date: "2024 - 2025",
...
- **流程設計**：在 tranning 之間插入新的移動步驟減少噪點`,
        links: [
          { label: "📃 查看報告", url: "https://drive.google.com/file/d/15socf0mkWe1OrEC5ysWpTwXxJ1jAjuEh/view?usp=sharing" },
        ],
      },
      {
        date: "2025",
...
- **PBRT-v4 擴充**：在 PBRT-v4 中添加 L-System 圖形生成功能`,
        links: [
          { label: "🔗 查看專案", url: "https://github.com/stanfc/pbrt-plus-v4/tree/l-system" },
        ],
      },
      {
        date: "2025 Spring",
...
- **工具串接**：讓 Agent 可以將回應的語法寫入 .tex 檔`,
        links: [
          { label: "🔗 查看專案", url: "https://github.com/stanfc/agent-project" },
        ],
      },
      {
        date: "2025 Spring",
...
- **指標設計**：cost-weighted accuracy 的計算與意義`,
        links: [
          { label: "🔗 查看專案", url: "https://github.com/joshuachen0213/ADL-Final" },
        ],
      },
      {
        date: "2026.3",
...
- **無伺服器架構**：Terraform 管理 AWS 資源的實務經驗`,
        links: [
          { label: "🔗 查看專案", url: "https://github.com/yenyu3/guardcircle-app" },
        ],
      },
      {
        date: "2026",
...
- **遊戲系統設計**：複雜規則的狀態機設計與實作`,
        links: [
          { label: "🔗 查看專案", url: "https://github.com/stanfc/listen-up" },
        ],
      },
      {
        date: "2025.6 - 2026.6",
...
- **Python Implementation Optimization**: I learned how to make Python efficiently use resources, especially in multiple loops, using multi-threading, loop optimization, and other methods to improve speed`,
        links: [
          { label: "🔗 View Project", url: "https://github.com/leolinpotato/ntu-vfx-2024" },
          { label: "🎥 Blender VFX", url: "https://www.youtube.com/watch?v=e7_iIwEm398" },
          { label: "🎥 Final Project", url: "https://youtu.be/KqNNqOy3fpY?si=4KVSvJS_8_uxlPGE" },
        ],
      },
      {
        date: "2024 Fall",
...
- **Git Usage**: Learned how to use git and GitHub for version control in teams`,
        links: [
          { label: "🎮 Play Game", url: "https://fhvirus.itch.io/caged?fbclid=IwZXh0bgNhZW0CMTAAAR3sYiRt9_hX8UyU68FCerY5O92KcjUp45jFvAippdTQ-LYH3yQsvf7chzQ_aem__vxlOau9PK69ds_E1oiPTQ" },
        ],
      },
      {
        date: "2024",
...
- **Independent Creation**: Cultivated ability to independently learn new knowledge and solve problems`,
        links: [
          { label: "🔗 View Project", url: "https://github.com/stanfc/Youtube-Comment-Emotion-Prediction-Tool" },
        ],
      },
      {
        date: "2024 - 2025",
...
- **Process Design**: Inserting new movement steps between training to reduce noise`,
        links: [
          { label: "📃 View Report", url: "https://drive.google.com/file/d/15socf0mkWe1OrEC5ysWpTwXxJ1jAjuEh/view?usp=sharing" },
        ],
      },
      {
        date: "2025",
...
- **PBRT-v4 Extension**: Add L-System graphics generation feature in PBRT-v4 so that users can generate complex shapes using L-System syntax`,
        links: [
          { label: "🔗 View Project", url: "https://github.com/stanfc/pbrt-plus-v4/tree/l-system" },
        ],
      },
      {
        date: "2025 Spring",
...
- **Tool Integration**: Allow Agent to write response syntax to .tex files`,
        links: [
          { label: "🔗 View Project", url: "https://github.com/stanfc/agent-project" },
        ],
      },
      {
        date: "2025 Spring",
...
- **Metric Design**: Cost-weighted accuracy calculation and its practical significance`,
        links: [
          { label: "🔗 View Project", url: "https://github.com/joshuachen0213/ADL-Final" },
        ],
      },
      {
        date: "2026.3",
...
- **Serverless Architecture**: Hands-on experience managing AWS resources with Terraform`,
        links: [
          { label: "🔗 View Project", url: "https://github.com/yenyu3/guardcircle-app" },
        ],
      },
      {
        date: "2026",
...
- **Game System Design**: State machine design for complex rule sets`,
        links: [
          { label: "🔗 View Project", url: "https://github.com/stanfc/listen-up" },
        ],
      },
      {
        date: "2025.6 - 2026.6",
